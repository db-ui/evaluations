...
Within this repository, we'd like to store evaluations that should get seperated from our regular codebase.
...
As these assets and visual guidelines are retrieved from our Deutsche Bahn Marketingportal, you'll agree with the ["Allgemeine Nutzungsbedingungen für das DB-Marketingportal" (german)]([https://marketingportal.extranet.deutschebahn.com/de/nutzungsbedingungen](https://marketingportal.extranet.deutschebahn.com/marketingportal/Nutzungsbedingungen-9702684)) in case of using them.
